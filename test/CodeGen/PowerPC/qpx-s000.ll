; RUN: llc < %s -O3 -mtriple=powerpc64 -mcpu=a2q -enable-misched -enable-aa-sched-mi | FileCheck %s
...
for.body4:                                        ; preds = %for.body4, %for.cond2.preheader
  ...
  %0 = bitcast double* %arrayidx to <4 x double>*
  %1 = load <4 x double>* %0, align 32, !tbaa !0
  %add = fadd <4 x double> %1, <double 1.000000e+00, double 1.000000e+00, double 1.000000e+00, double 1.000000e+00>
  %2 = bitcast double* %arrayidx6 to <4 x double>*
  store <4 x double> %add, <4 x double>* %2, align 32, !tbaa !0
  ...
  %3 = bitcast double* %arrayidx.4 to <4 x double>*
  %4 = load <4 x double>* %3, align 32, !tbaa !0
  %add.4 = fadd <4 x double> %4, <double 1.000000e+00, double 1.000000e+00, double 1.000000e+00, double 1.000000e+00>
  %5 = bitcast double* %arrayidx6.4 to <4 x double>*
  store <4 x double> %add.4, <4 x double>* %5, align 32, !tbaa !0
  ...
  %6 = bitcast double* %arrayidx.8 to <4 x double>*
  %7 = load <4 x double>* %6, align 32, !tbaa !0
  %add.8 = fadd <4 x double> %7, <double 1.000000e+00, double 1.000000e+00, double 1.000000e+00, double 1.000000e+00>
  %8 = bitcast double* %arrayidx6.8 to <4 x double>*
  store <4 x double> %add.8, <4 x double>* %8, align 32, !tbaa !0
  ...
  %9 = bitcast double* %arrayidx.12 to <4 x double>*
  %10 = load <4 x double>* %9, align 32, !tbaa !0
  %add.12 = fadd <4 x double> %10, <double 1.000000e+00, double 1.000000e+00, double 1.000000e+00, double 1.000000e+00>
  %11 = bitcast double* %arrayidx6.12 to <4 x double>*
  store <4 x double> %add.12, <4 x double>* %11, align 32, !tbaa !0
